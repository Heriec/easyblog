    ...
    <el-header class="header">
      ...
      >
        ...
        <el-button
          ...
          style="margin-left: 10px"
          slot="reference"
          @click="showTags(article.dynamicTags)"
        >
        </el-button>
      </el-popover>
...
export default {
  ...
  methods: {
    ...
    saveTags(){
      // var tmp = this.tags;
      // if (this.ntags.length == tmp.length) {
      //   for (var i = 0; i < this.ntags.length; i++) {
      //     for (var j = 0; j < tmp.length; j++) {
      //       if (this.nTags[i].id == tmp[j]) {
      //         tmp.splice(j, 1);
      //         break;
      //       }
      //     }
